...
function legendClickCallback(a) { for (var e = (a = a || window.event).target || a.srcElement;
        "LI" !== e.nodeName;) e = e.parentElement; var s = e.parentElement,
...
$(".nav-search .input-group > input").focus(function(a) { $(this).parent().addClass("focus") }).blur(function(a) { $(this).parent().removeClass("focus") }), $(function() { $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), layoutsColors() }), $(document).ready(function() { $(".btn-refresh-card").on("click", function() { var a = $(this).parents(".card");
        a.length && (a.addClass("is-loading"), setTimeout(function() { a.removeClass("is-loading") }, 3e3)) }); var a = $(".sidebar .scrollbar");
    a.length > 0 && a.scrollbar(); var e = $(".main-panel .content-scroll");
    e.length > 0 && e.scrollbar(); var s = $(".messages-scroll");
    s.length > 0 && s.scrollbar(); var o = $(".tasks-scroll");
    ...
    t.length > 0 && t.scrollbar(), $(".scroll-bar").draggable(), $("#search-nav").on("shown.bs.collapse", function() { $(".nav-search .form-control").focus() }); var c = !1,
        ...
        f = 0,
        b = 0; if (!c) {
        (C = $(".sidenav-toggler")).on("click", function() { 1 == h ? ($("html").removeClass("nav_open"), C.removeClass("toggled"), h = 0) : ($("html").addClass("nav_open"), C.addClass("toggled"), h = 1) }), c = !0 } if (!m) { var C = $(".quick-sidebar-toggler");
        C.on("click", function() { 1 == h ? ($("html").removeClass("quick_sidebar_open"), $(".quick-sidebar-overlay").remove(), C.removeClass("toggled"), m = 0) : ($("html").addClass("quick_sidebar_open"), C.addClass("toggled"), $('<div class="quick-sidebar-overlay"></div>').insertAfter(".quick-sidebar"), m = 1) }), $(".wrapper").mouseup(function(a) { var e = $(".quick-sidebar");
        ...
        w.on("click", function() { 1 == u ? ($("html").removeClass("topbar_open"), w.removeClass("toggled"), u = 0) : ($("html").addClass("topbar_open"), w.addClass("toggled"), u = 1) }), d = !0 } if (!g) { var k = $(".toggle-sidebar");

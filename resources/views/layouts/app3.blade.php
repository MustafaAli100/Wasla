                    ...
                    <div class="user">
                        ...
                        <div class="info">
                            ...
                            <div class="collapse in" id="collapseExample">
                                <ul class="nav">
                                    <li>
                                        {{-- show the profile according to the user type. this is just an example to show the programmer profile. the login is done by using if condition example:- if(auth()-user->hasRole('programmer')){
                                        <a href="/showpro">

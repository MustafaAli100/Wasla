            ...
            <div class="user">
                ...
                <div class="info">
                    <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                        <span>
                            mohammed Ali
                            <span class="user-level">programmer</span>
                    ...
                    <div class="collapse in" id="collapseExample">
                        <ul class="nav">
                            <li>
								{{-- show the profile according to the user type.
								this is just an example to show the programmer profile.
								the login is done by using if condition 
								example:- 
								if(auth()-user->hasRole('programmer')){
									 <a href="/showpro">
                                    <span class="link-collapse">My Profile</span>
                                </a>
								}sleseif(auth()-user->hasRole('Owner')){
									 <a href="/showOwner">
                                    <span class="link-collapse">My Profile</span>
                                </a>
								} ext .... 
...
<!-- End Sidebar -->
    ...
    <footer class="footer col-12 d-block">
        <div class="container-fluid">
            <nav class="pull-left">
                <ul class="nav"> 
                    <li class="nav-item">
             ...
             <div class="copyright ml-auto">
                 2000-2019 wasla.com, made  <!--<i class="fa fa-heart heart text-danger"></i>--> by 
                 <a href="https://www.themekita.com">Teem  wasla</a> 
             </div>
        </div>
    </footer>
</div>

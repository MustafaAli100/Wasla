...
<head>
    ...
    <link href="desgin/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<i class="far fa-money-bill-alt fa-stack-1x fa-inverse"></i>
    ...
    <script src="desgin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="desgin/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Contact form JavaScript -->
    <script src="desgin/js/jqBootstrapValidation.js"></script>
    <script src="desgin/js/contact_me.js"></script>

    <!-- Custom scripts for this template -->
    <script src="desgin/js/agency.min.js"></script>
